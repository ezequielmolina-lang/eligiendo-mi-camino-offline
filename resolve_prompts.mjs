...
const bat=JSON.parse(readFileSync(B+'battery.json','utf8'));
...
writeFileSync(B+'prompts_resolved.json', JSON.stringify(out,null,1));
console.log('resueltos',out.length,'escenarios -> prompts_resolved.json');
